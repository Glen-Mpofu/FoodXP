...
model = load_model(r"C:\Users\Tshepo Mpofu\Desktop\i.am.mgt\Projects Programming\Wil Project\FoodXP\backend\model\fridge_pantry_model.keras")
...
if __name__ == "__main__":
    app.run(host="192.168.101.124", port=5001, threaded = True)
